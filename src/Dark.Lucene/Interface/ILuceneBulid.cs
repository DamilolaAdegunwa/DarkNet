...
namespace Dark.Lucene.Interface
{
    public interface ILuceneBulid<T> where T : Dark.Core.Domain.Entity.IEntity<string>
    {
        ...
        /// <returns></returns>
        List<T> QueryByPage(string strCondition, PageDto page, string strFilter);
        #endregion
    }
}
